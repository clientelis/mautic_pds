 ...
 */
class Group extends \Mautic\PointBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Group' . "\0" . 'id', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Group' . "\0" . 'name', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Group' . "\0" . 'description', 'changes', 'new', 'deletedId', 'pastChanges'];
        }
     ...
     * {@inheritDoc}
     */
    public function setDescription(?string $description): \Mautic\PointBundle\Entity\Group
    {
     ...
     * {@inheritDoc}
     */
    public function setName(?string $name): \Mautic\PointBundle\Entity\Group
    {
